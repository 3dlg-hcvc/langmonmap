...
class Navigator:
    ...
    def __init__(self,
        ...
        self.detections = {}
        self.use_detector = config.planner.use_detector
    ...
    def add_data(self,
        ...
        self.saw_left = False
        self.saw_right = False
        if len(self.detections) > 0 and len(self.detections["boxes"]) > 0:
            # wants rgb
    ...
    def get_map(self,
        ...
        similarity = self.model.compute_similarity(map_features, self.query_text_features, num_layers=self.one_map.n_layers)
